...
import { Camera, CameraIcon, Clock, MapPin, UserCheck, UserPlus, X } from "lucide-react";
	...
	return (
		<div className='bg-white shadow rounded-lg mb-6'>
			<div
				...
				style={{
					backgroundImage: `url('${editedData.bannerImg || userData.data.bannerImg || "/banner.png"}')`,
				}}
			>
				{isEditing && (
			...
			<div className='p-4'>
				<div className='relative -mt-20 mb-4'>
					<img
						...
						src={editedData.profilePicture || userData.data.profilePicture || "/avatar.png"}
				...
				<div className='text-center mb-4'>
					{isEditing ? (
						<input
							type='text'
							value={editedData.name ?? userData.data.name}
							onChange={(e) => setEditedData({ ...editedData, name: e.target.value })}
							className='text-2xl font-bold mb-2 text-center w-full'
						/>
					) : (
						<h1 className='text-2xl font-bold mb-2'>{userData.data.name}</h1>
					)}

					{isEditing ? (
						<input
							type='text'
							value={editedData.headline ?? userData.data.headline}
					...
					<div className='flex justify-center items-center mt-2'>
						...
						{isEditing ? (
							<input
								type='text'
								value={editedData.location ?? userData.data.location}
								onChange={(e) => setEditedData({ ...editedData, location: e.target.value })}
								className='text-gray-600 text-center'
							/>
						) : (
							<span className='text-gray-600'>{userData.data.location}</span>
						)}
					</div>
				</div>
