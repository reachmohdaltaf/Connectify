...
const ResponsivePostCreation = ({ authUser }) => {
    ...
    return (
        <Card className="lg:hidden flex-col max-h-screen     mb-1 bg-white shadow-sm p-4 gap-5 items-center">
...
export default ResponsivePostCreation;
