...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-colors disabled:pointer-events-none disabled:bg-neutral-100 disabled:from-neutral-100  disabled:to-neutral-100  disabled:text-neutral-300 border border-neutral-200 shadow-sm [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        primary:
          "bg-gradient-to-b from-blue-500 to-blue-600 text-primary-foreground  hover:from-blue-700 hover:to-blue-700",
        destructive:
        ...
        teritary: "bg-blue-100 text-blue-600 border-transparent shadow-none hover:bg-blue-200/80",
      },
      size: {
